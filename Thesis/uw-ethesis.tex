...
% Note: mathtools loads amsmath, so no need to load separately
\usepackage{amssymb,amstext,amsthm,mathtools,amsfonts} % math symbols and environments
\usepackage{stmaryrd}
\usepackage{enumitem}
\usepackage[pdftex]{graphicx} % For including graphics N.B. pdftex graphics driver 
\usepackage[T1]{fontenc}
\usepackage[section]{placeins}  % ensures floats don't end up too far away

%---------------------------------------------------------------
% Load TikZ for braces describing matrices (Chap 4)
\usepackage{tikz}
...
\pgfkeys{tikz/mymatrixbrace/.style={decorate}}
\newcommand\mymatrixbraceoffseth{0.5em}
\newcommand\mymatrixbraceoffsetv{0.2em}

% Now the commands to produce the braces.
% #1 is the name (m), #2, #3 are the range of rows/cols, and #4 is a label
...
\newcommand{\frob}[2]{{\left\langle {#1}, {#2} \right\rangle}_F}
...
\DeclarePairedDelimiter\floor{\lfloor}{\rfloor} % \floor* to scale delimiters
...
\hypersetup{
    ...
    pdftitle={Kinodynamic Planning with mu-Calculus Specifications},    % title
    pdfauthor={Luc Larocque},    % author: CHANGE THIS TEXT! and uncomment this line
    pdfsubject={Kinodynamic Planning with mu-Calculus Specifications},  % subject
    pdfkeywords={sampling} {motion planning} {temporal logic} {quadrotor} {mu-calculus} {kinodynamic planning} {differential constraints}, % list of keywords
